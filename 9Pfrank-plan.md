...
| --- | --- | --- |
| 9P.original (editions 1–3) | The pre-version attach/walk/read/write/clunk model | A separate codec and frontend for a distinct wire format: no `Tversion`, fixed names and stat records, p9sk1/DES authentication |
