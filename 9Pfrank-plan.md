...
Because 9Pfrank is a superset, any 9P client should be able to switch to it by changing its version string and remapping opcode numbers. This is directional, not a guarantee.
