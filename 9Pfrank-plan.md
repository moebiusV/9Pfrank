...
- **One binary, every dialect.** filsys ships one binary that mounts every edition. 9Pfrank ships `lib9pfrank` and one server that speak every dialect through the codecs.
